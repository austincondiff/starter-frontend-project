...
import { useScheduler } from "../calendar-provider";
      ...
      <AnimatePresence initial={false} custom={direction} mode="wait">
        ...
        >
          {daysOfWeek.map((day, idx) => (
            <div
              key={idx}
              className="text-left my-8 text-md tracking-tighter font-medium"
            >
              {day}
            </div>
          ))}
          ...
          {Array.from({ length: startOffset }).map((_, idx) => (
            <div key={`offset-${idx}`} className="h-[150px] opacity-50">
              <div className={clsx("font-semibold relative text-md mb-1")}>
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={clsx(
                      "font-semibold relative text-md mb-1",
                      dayEvents.length > 0
                        ? "text-primary-600"
